...
**Only perform this step if the user passed `--create` as input.**
...
**Do NOT add any attribution, "generated by", or "co-authored-by" footers.** Write only the description from Step 4.
